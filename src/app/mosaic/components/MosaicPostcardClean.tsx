...
interface MosaicPostcardCleanProps {
  repoPath: string;
  repoStats?: RepoStats;
  cityData: any;
...
export const MosaicPostcardClean: React.FC<MosaicPostcardCleanProps> = ({
  repoPath,
  repoStats,
  cityData,
  highlightLayers,
  ...
  const showGradient = true; // Always show gradient in clean version
